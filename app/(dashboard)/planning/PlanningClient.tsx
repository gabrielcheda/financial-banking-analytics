                    ...
                    <Card key={goal.id}>
                      <CardContent className="pt-6">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${goal.priority === 'high'
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    inputMode="decimal"
                    value={savingsGoal}
                    onChange={(e) => setSavingsGoal(parseLocaleNumber(e.target.value) ?? 0)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCurrentSavings(parseLocaleNumber(e.target.value) ?? 0)}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setMonthlyContribution(parseLocaleNumber(e.target.value) ?? 0)}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    inputMode="decimal"
                    value={interestRate}
                    onChange={(e) => setInterestRate(parseLocaleNumber(e.target.value) ?? 0)}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {(budgets || []).map((budget: { category: string; spent: number; limit: number; percentage: number }) => (
                    ...
                    >
                      ...
                      <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all ${(budget.percentage ?? 0) > 100
                            ? 'bg-red-500'
                            : (budget.percentage ?? 0) > 80
                              ? 'bg-yellow-500'
                              : 'bg-green-500'
              ...
              {isLoadingBills ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {(billsResponse || []).map((bill: BillDTO) => (
                    <div
                      key={bill.id}
                      className={`p-4 rounded-lg border-2 ${bill.isPaid
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${bill.isPaid
